...
<body class="min-h-screen font-sans antialiased selection:bg-brandPurple selection:text-white text-slate-900 dark:text-white transition-colors duration-300 overflow-hidden flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-lightBg dark:bg-darkBg relative flex-col justify-between p-12 overflow-hidden border-r border-gray-200 dark:border-gray-800">
        ...
        <div class="relative z-10 max-w-lg mt-auto mb-auto">
            <span class="px-3 py-1 mb-6 inline-block rounded-full bg-brandPurple/10 dark:bg-brandPurple/20 text-brandPurple dark:text-[#d3a3ff] text-sm font-semibold border border-brandPurple/20">Registo de Agente</span>
            ...
            <p class="text-textMutedLight dark:text-textMutedDark text-lg">
                Junte-se à nossa rede de agentes autorizados e ofereça serviços financeiros na sua comunidade. Ganhe comissões por cada transação processada.
            </p>
        ...
        <div class="absolute -bottom-20 -right-20 w-[400px] h-[400px] bg-brandGreen/20 dark:bg-brandGreen/10 rounded-full blur-3xl mix-blend-multiply dark:mix-blend-lighten pointer-events-none"></div>
    </div>
        ...
        <div class="flex-1 flex items-center justify-center p-6 sm:p-12">
            <div class="w-full max-w-md">
                <div class="mb-8 text-center lg:text-left">
                    ...
                    <p class="text-textMutedLight dark:text-textMutedDark">O registo é exclusivo para agentes autorizados.</p>
                </div>

                <!-- Mensagens -->
                <div id="register-error" class="hidden mb-4 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl text-red-600 dark:text-red-400 text-sm"></div>
                <div id="register-success" class="hidden mb-4 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl text-green-600 dark:text-green-400 text-sm"></div>

                <form id="register-form" class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label for="first_name" class="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1.5">Primeiro Nome</label>
                            <input type="text" id="first_name" name="first_name" required class="w-full px-4 py-3 bg-gray-50 dark:bg-[#15111f] border border-gray-200 dark:border-gray-800 rounded-xl text-slate-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brandPurple/50 focus:border-brandPurple transition-all" placeholder="João">
                        </div>
                        <div>
                            <label for="last_name" class="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1.5">Último Nome</label>
                            <input type="text" id="last_name" name="last_name" required class="w-full px-4 py-3 bg-gray-50 dark:bg-[#15111f] border border-gray-200 dark:border-gray-800 rounded-xl text-slate-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brandPurple/50 focus:border-brandPurple transition-all" placeholder="Silva">
                        </div>
                    </div>

                    <div>
                        <label for="reg-email" class="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1.5">E-mail</label>
                        <input type="email" id="reg-email" name="email" required class="w-full px-4 py-3 bg-gray-50 dark:bg-[#15111f] border border-gray-200 dark:border-gray-800 rounded-xl text-slate-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brandPurple/50 focus:border-brandPurple transition-all" placeholder="agente@email.com">
                    </div>

                    <div>
                        <label for="phone" class="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1.5">Nº de Telefone</label>
                        <input type="tel" id="phone" name="phone" required class="w-full px-4 py-3 bg-gray-50 dark:bg-[#15111f] border border-gray-200 dark:border-gray-800 rounded-xl text-slate-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brandPurple/50 focus:border-brandPurple transition-all" placeholder="+244 9XX XXX XXX">
                    </div>

                    <div>
                        <label for="bi_number" class="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1.5">Número do BI</label>
                        <input type="text" id="bi_number" name="bi_number" required class="w-full px-4 py-3 bg-gray-50 dark:bg-[#15111f] border border-gray-200 dark:border-gray-800 rounded-xl text-slate-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brandPurple/50 focus:border-brandPurple transition-all" placeholder="005XXXXXXXXLA0XX">
                    </div>

                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label for="reg-password" class="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1.5">Palavra-passe</label>
                        ...
                        <div>
                            <label for="reg-password-confirm" class="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1.5">Confirmar</label>
                            <input type="password" id="reg-password-confirm" name="password_confirmation" required minlength="6" class="w-full px-4 py-3 bg-gray-50 dark:bg-[#15111f] border border-gray-200 dark:border-gray-800 rounded-xl text-slate-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brandPurple/50 focus:border-brandPurple transition-all" placeholder="••••••">
                        </div>
                    </div>

                    <!-- Termos -->
                    <div class="flex items-start gap-2 mt-2">
                        <input type="checkbox" id="accept-terms" required class="mt-1 w-4 h-4 rounded border-gray-300 text-brandPurple focus:ring-brandPurple">
                        <label for="accept-terms" class="text-sm text-textMutedLight dark:text-textMutedDark">
                            Concordo com os <a href="{{ route('site.terms') }}" class="text-brandPurple hover:underline">Termos e Condições</a> e a <a href="{{ route('site.privacy') }}" class="text-brandPurple hover:underline">Política de Privacidade</a>
                        </label>
                    </div>

                    <div class="pt-2">
                        <button type="submit" id="register-btn" class="w-full py-4 bg-brandGreen hover:bg-brandGreenHover text-white text-lg font-semibold rounded-xl transition-all duration-300 shadow-lg shadow-brandGreen/20 flex items-center justify-center gap-2">
                            <span>Criar Conta</span>
                            <svg id="register-spinner" class="hidden animate-spin w-5 h-5" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path></svg>
                        </button>
                    </div>
                </form>
                ...
                <p class="text-center mt-8 text-textMutedLight dark:text-textMutedDark">
                    Já tem conta?
                    <a href="{{ route('site.login') }}" class="font-semibold text-brandPurple hover:text-brandGreen transition-colors">Iniciar sessão</a>
                </p>
            </div>
        </div>
    </div>
